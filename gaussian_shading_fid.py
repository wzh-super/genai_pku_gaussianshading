...
if __name__ == '__main__':
    ...
    parser.add_argument('--prompt_file', default='/root/autodl-tmp/Shared/fid_outputs/coco/meta_data.json')
    parser.add_argument('--gt_folder', default='/root/autodl-tmp/Shared/fid_outputs/coco/ground_truth')
