...
if __name__ == '__main__':
    ...
    parser.add_argument('--dataset_path', default='/root/autodl-tmp/Shared/Gustavosta/Stable-Diffusion-Prompts')
    parser.add_argument('--model_path', default='/root/autodl-tmp/Shared/stabilityai/stable-diffusion-2-1-base')
